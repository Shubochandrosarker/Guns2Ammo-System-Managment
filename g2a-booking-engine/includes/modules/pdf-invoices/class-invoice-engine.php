...
.inv__brand-text { font-family: Impact, 'Arial Black', sans-serif; font-size: 28px; letter-spacing: .04em; }
.inv__title { font-family: Impact, sans-serif; font-size: 36px; letter-spacing: .08em; margin: 0; }
