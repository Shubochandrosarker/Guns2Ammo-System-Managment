	...
	function PlansApp() {
		...
		return h('div', { className: 'mb-app' },
			...
			loading && !plans.length
				? h('div', { className: 'mb-card mb-empty' }, __('Loading plans…', 'memberistic'))
				: !plans.length
					? h('div', { className: 'mb-card mb-empty' }, __('No plans yet. Add your first one to get started.', 'memberistic'))
