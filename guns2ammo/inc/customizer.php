...
add_action( 'customize_register', function ( $wp_customize ) {
	...
	$fields = [
		...
		'g2a_review_count' => [ 'label' => 'Reviews (manual fallback)', 'default' => '556' ],
		'g2a_places_api_key' => [ 'label' => 'Google Places API key (enables live review count, refreshed twice daily)', 'default' => '' ],
		'g2a_place_id'       => [ 'label' => 'Google Place ID', 'default' => 'ChIJaSRMhpGvK4cR4kE_E-jZvKE' ],
