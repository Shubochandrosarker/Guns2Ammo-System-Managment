...
<section class="faq">
  <div class="c">
    ...
    <details class="q"><summary>Do you offer the California CCW qualification?<span class="ex">+</span></summary><div class="a">We offer the live-fire qualification component required for the California CCW permit  this is the firearm-qualification step where customers qualify the firearms they intend to place on their permit, supervised by an RSO on an open lane. It is <em>not</em> the education/training component of the California CCW process; that portion must be completed elsewhere. See our <a href="<?php echo esc_url( home_url( '/training/california-ccw/' ) ); ?>" style="color:var(--color-brass-bright);">California CCW page</a> for booking and current pricing.</div></details>
