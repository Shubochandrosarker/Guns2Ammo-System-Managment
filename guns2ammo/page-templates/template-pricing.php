...
<div class="plans-wrap">
  <article class="plan fade-up d1" data-plan="defender">
    ...
    <div class="pays">Individual membership foundation for Guns 2 Ammo  Annual billing saves $59.89/year</div>
    <ul class="feats">
      <li>Includes 1 total person</li>
      <li>Individual membership access</li>
      <li>Member profile and waiver tracking</li>
      <li>Unlimited range time, all open hours</li>
  ...
  <article class="plan popular fade-up d2" data-plan="patriot">
    ...
    <div class="pays">Two-person membership with individual linked member profiles  Annual billing saves $29.89/year</div>
    <ul class="feats">
  ...
  <article class="plan fade-up d3" data-plan="guardian">
    ...
    <div class="pays">Four-person membership for families or groups with separate people records  Annual billing saves $69.89/year</div>
    <ul class="feats">
