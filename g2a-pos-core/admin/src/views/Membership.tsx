  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Detects Memberistic, WooCommerce Memberships, MemberPress, or a custom user-meta schema. Host themes can override via the g2a_pos_membership_lookup filter."
      />
          ...
          <div className="card mb-4 p-5">
            ...
            <div className="mt-3 grid gap-2">
              ...
              <label className="flex items-center gap-3 rounded-lg border border-zinc-200 p-3 dark:border-zinc-800">
                ...
                <span className="text-xs text-zinc-500">Try Memberistic → WC Memberships → MemberPress → user-meta.</span>
              </label>
            </div>
          </div>
