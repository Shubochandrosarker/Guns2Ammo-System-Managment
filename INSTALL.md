...
| G2A Booking Engine plugin | `g2a-booking-engine.zip` (current archive `g2a-booking-engine-1.9.9.16.zip`) | **1.9.9.16** ✅ (Stripe webhook signature/idempotency fix, see `docs/INCIDENT-AUDIT-2026-07-19-STRIPE-SIGNUP.md`) |
| Memberistic Membership Solutions plugin | `memberistic-membership-solutions.zip` (current archive `memberistic-membership-solutions-1.18.4.zip`) | **1.18.4** ✅ (Stripe webhook + activation reliability fix) |
