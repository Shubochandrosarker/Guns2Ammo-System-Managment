...
|---|---|---|
| Theme | `WPistic-Theme-For-G2A-Version-1.8.9.zip` *(also in `releases/`, current archive `WPistic-Theme-For-G2A-Version-1.27.11.zip`)* | **1.27.11** |
| Booking Engine plugin | `g2a-booking-engine.zip` (current archive `g2a-booking-engine-1.9.9.7.zip`) | **1.9.9.7** (DB schema 1.5.2) |
