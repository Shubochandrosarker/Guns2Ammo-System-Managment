...
| Booking Engine plugin | `g2a-booking-engine.zip` (current archive `g2a-booking-engine-1.9.9.8.zip`) | **1.9.9.8** (DB schema 1.5.2) |
| Memberistic Membership Solutions plugin | `memberistic-membership-solutions.zip` (current archive `memberistic-membership-solutions-1.10.4.zip`) | **1.10.4** |
...
| Verifyistic (age verification) plugin | `verifyistic.zip` (current archive `verifyistic-1.4.3.zip`) | **1.4.3** |
