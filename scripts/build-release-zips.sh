...
for plugin in g2a-booking-engine g2a-theme-control memberistic-membership-solutions wpistic-contact-form-main verifyistic messageistic g2a-pos-core advanced-ffl-checkout; do
  if [ -d "$plugin" ]; then
