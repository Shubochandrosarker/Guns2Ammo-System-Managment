...
* Fix: saving one Settings tab wiped the other tabs (and could make a just-checked box reappear unchecked) because all tabs share one option group and core nulls any option missing from the submitted form. Every other tab's stored values are now carried through the save.
