 ...
 *
 * Guns2Ammo runs both a shooting range (Memberistic members) and an online
 * FFL-transfer WooCommerce storefront (the separate advanced-ffl-checkout
 * plugin) — the same person is often both. This surfaces a member's own
 * FFL firearm-transfer history on their account dashboard, read-only,
 * matched by email against advanced-ffl-checkout's own `transfers` table
 * (same-site direct read — the same pattern this plugin's POS Bridge and
 * coreSTORE Bridge already use for their sibling integrations).
 *
