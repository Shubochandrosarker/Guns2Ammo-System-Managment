...
final class Guest_Pass_Audit_Command {
	...
	const SEGMENT_META_KEY   = 'g2ab_customer_segment';
	const SEGMENT_META_VALUE = 'range_guest';
	...
	/**
	 * Audit Guest Pass memberships auto-created from range-lane bookings.
	 *
	 ...
	 * g2ab_customer_segment=range_guest user meta. WP users, bookings,
	 * payments, waiver records and QR/verification data are left untouched.
	 *
	 * ## OPTIONS
	 *
	 * [--apply]
	...
	/**
	 * Cached wp_g2ab_bookings table name, or '' when the booking engine
