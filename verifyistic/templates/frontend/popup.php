  ...
  <div id="verifyistic-popup">
    ...
    <div class="vfy-inner">
      ...
      <form id="vfy-verify-form" novalidate enctype="multipart/form-data">
        ...
        <div class="vfy-form-group">
          <label class="vfy-form-label"><?php echo esc_html($id_label); ?> <span style="color:#f87171;">*</span></label>
          <div class="vfy-upload-area" role="button" tabindex="0" aria-label="Upload ID document">
            <input type="file" class="vfy-file-input" name="id_file" accept="image/jpeg,image/png,image/gif,application/pdf" required aria-required="true">
        ...
        <div class="vfy-form-group">
          <label class="vfy-form-label"><?php echo esc_html($selfie_label); ?> <span style="color:#f87171;">*</span></label>
